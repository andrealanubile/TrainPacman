...
def optimize_model():
    ...
    with torch.no_grad():
        next_state_values[non_final_mask] = target_net(non_final_next_states.squeeze()).max(1).values
...
if __name__ == '__main__':
    ...
    for i_episode in tqdm(range(NUM_EPISODES)):
        ...
        for t in count():
            ...
            reward, state, action, next_state, done = game.update(action, state, next_state, exploration_rate, policy_net)
